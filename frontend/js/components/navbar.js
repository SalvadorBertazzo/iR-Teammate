            ...
            <nav class="bg-white border-b border-surface-200 fixed top-0 left-0 right-0 z-50">
                    ...
                    <div class="flex items-center justify-between h-14">
                        <div class="flex items-center gap-8">
                            ...
                            <div class="hidden md:flex items-center gap-1">
                                ...
                                ${user ? `
                                    <a href="#/posts/create" class="text-content-secondary hover:text-content-primary px-3 py-2 rounded-lg text-sm font-medium transition-colors hover:bg-surface-100">
                                        Create Post
                                    </a>
                        ...
                        <div class="flex items-center gap-3">
                            ${user ? `
                                <a href="#/profile" class="text-content-secondary hover:text-content-primary text-sm font-medium transition-colors">
                                    ${escapeHtml(user.username)}
                                </a>
                                <button id="logout-btn" class="btn-secondary px-3 py-1.5 rounded-lg text-sm">
                                    Logout
                                </button>
                            ` : `
                ...
                <div class="md:hidden border-t border-surface-200">
                    <div class="px-2 pt-2 pb-3 space-y-1">
                        ...
                        ${user ? `
                            <a href="#/posts/create" class="text-content-secondary hover:text-content-primary hover:bg-surface-100 block px-3 py-2 rounded-lg text-base font-medium transition-colors">
                                Create Post
                            </a>
                            <a href="#/my-posts" class="text-content-secondary hover:text-content-primary hover:bg-surface-100 block px-3 py-2 rounded-lg text-base font-medium transition-colors">
                                My Posts
                            </a>
                            <a href="#/my-applications" class="text-content-secondary hover:text-content-primary hover:bg-surface-100 block px-3 py-2 rounded-lg text-base font-medium transition-colors">
                                My Applications
                            </a>
                        ` : ''}
                    </div>
